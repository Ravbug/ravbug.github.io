...
function render(){
  //draw into iframe
  p.srcdoc = ShowdownConverter.makeHtml(editor.getValue());
}
...
function createShareLink(){
    if (editor.getValue().length < 4096 && generateEmbed(editor.getValue()) != undefined){
      ...
      document.getElementById('urlCopy').value=window.location.protocol + "//" + window.location.hostname+"/markdownviz?c="+link;
